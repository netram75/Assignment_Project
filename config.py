...
# Set to 0.0 — local MiniLM gives near-zero scores for Hindi queries against English PDFs;
# all refusals are handled by the LLM system prompt (Rule 3), hard floor is not needed
RELEVANCE_HARD_FLOOR = 0.0
